...
export function OpsTab() {
    ...
    const maxReqs = summary
        ? Math.max(
              ...Object.values(summary.operations).map((o) => o.request_count),
              1,
          )
        : 1;
                ...
                <Card>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {readiness.dependencies.map((dep: DependencyStatus) => (
                            ...
                            >
                                <div
                                    className={`w-3 h-3 rounded-full shrink-0 ${statusDot(dep.status)}`}
                                />
                ...
                <>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                            ...
                            <div
                                className={`rounded-lg border p-3 text-center ${
                                    summary.alert_status === "ok" ||
                                    summary.alert_status === "healthy"
                    ...
                    {Object.keys(summary.operations).length > 0 && (
                        <Card title="Operações">
                            <div className="space-y-4">
                                {Object.entries(summary.operations).map(
                                    ([name, op]) => (
                                        <div key={name}>
                        ...
                        <Card title="Erros Recentes">
                            <ul className="space-y-2">
                                {summary.recent_errors.map((e, i) => (
                                    <li
                                        key={i}
                                        className="flex items-start gap-3 text-sm bg-red-50 dark:bg-red-950/30 border border-red-100 dark:border-red-900 rounded-lg px-3 py-2"
                                    >
                                        <Icon
                                        ...
                                        <div className="flex-1">
                                            ...
                                            {Object.keys(e.dimensions).length >
                                                0 && (
